package com.example.reto2.logic
...
object TicTacToeGame {
    ...
    /**
     * Computes the computer's next move based on difficulty.
     * Returns the 0-indexed position (0-8) or -1 if no move is available.
     */
    fun getComputerMove(board: List<Char>, difficulty: Difficulty): Int {
        ...
        // 3. HARD: pick strategically: center, corners, or random
